              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-row justify-center items-center gap-2  mt-3 ">
                    <button
                      className={`flex h-full rounded-md p-2 hover:bg-violet-600
                    ${
                    ...
                    >
                      ...
                      <div className="flex flex-row justify-center items-center gap-3">
                          ...
                          className=" text-xs  text-right lg:text-sm outline-none pl-5  p-3 font-semibold bgblackbn border-[1px] border-gray-800
